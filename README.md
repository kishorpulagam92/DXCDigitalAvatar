# DXC Digital Human Avatar with Azure OpenAI Realtime API

A digital human avatar application that integrates Azure OpenAI Realtime API with Azure Speech Services to create an interactive AI assistant named Dixie for technical support.

## Features

- **Real-time Conversations**: Uses Azure OpenAI Realtime API for natural, flowing conversations
- **Digital Human Avatar**: Visual avatar powered by Azure Speech Services
- **Technical Support Focus**: Specialized for DXC Technology IT support scenarios
- **Voice Interaction**: Speech-to-text and text-to-speech capabilities
- **Web Interface**: Modern web-based UI with real-time chat
